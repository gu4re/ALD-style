 ...
 *  is not allowed</li>
* <li>
 *  <a style="color: #E89B6C; display: inline;">ErrorController</a>
 *  - Controls the mapping of the error page to redirect everyone to the 404
 *  error page when an invalid url is typed</li>
* <li><a style="color: #E89B6C; display: inline;">HomeController</a> - Controls the mapping of the home page</li>
* <li><a style="color: #E89B6C; display: inline;">CartController</a>
 * - Controls the mapping of the cart page and all related to
 * add and keep the control of products, in this case, shoes</li>
 * <li><a style="color: #E89B6C; display: inline;">rest</a> - subfolder containing all rest controllers</li>
 * </ul>
*/
